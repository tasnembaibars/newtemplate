...
<body>
    ...
    <section class="bg-success py-5" id="back">
        <div class="container" >
    ...
    <section class="container py-5">
        <div class="row text-center pt-5 pb-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                   And because we take care of you all time we provide the following services for 24/7 
                </p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    <div class="h1 text-success text-center"><i class="fa-regular fa-heart"></i></div>
                    <h2 class="h5 mt-4 text-center">Grooming Services</h2>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 class="h5 mt-4 text-center">24 Hours veterinarian </h2>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-light py-5">
        <div class="container my-4">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    <h1 class="h1">How we spoil our pets?</h1>
                    <p>
                    Summer Grooming Tips to Keep Dogs Cool
                    </p>
                </div>
                                    ...
                                    <div class="carousel-item">
                                        <div class="row">
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src="images/care5.jpg" alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src="images/care6.jpg" alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    <h2 class="h2 text-success border-bottom pb-3 border-light logo">Animall Shop</h2>
