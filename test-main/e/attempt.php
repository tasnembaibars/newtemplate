<?php
require "config.php";session_start();require "navbar.php";?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8">
...
$orders = $db->prepare('SELECT * FROM users
  JOIN cart  ON (users.user_id =cart.user_f_id)
   JOIN  products ON (users.user_id =products.product_id)')  ;
$orders->execute();
